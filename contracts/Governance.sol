...
contract Governance is IGovernance {
    ...
    function closeCrisis(uint256 crisisId) external override {
        ...
        // Stop accepting donations for this crisis. Leftover escrow remains
        // and may be redirected to an open crisis via redirectLeftoverFunds().
    ...
    /// @inheritdoc IGovernance
    /// @dev Allows Tier-3 multisig to redirect leftover funds from a CLOSED crisis
    ///      to any non-CLOSED crisis. Delegates the actual transfer to DonationManager.
